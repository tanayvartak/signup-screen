...
import 'package:practice_ui/signupscreen.dart';


class AdharCardUploadScreen extends StatefulWidget {
  @override
  _AdharCardUploadScreenState createState() => _AdharCardUploadScreenState();
}

class _AdharCardUploadScreenState extends State<AdharCardUploadScreen> {
  File _frontimage;
  File _backimage;
